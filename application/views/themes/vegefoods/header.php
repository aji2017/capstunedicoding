...
<html lang="en">
  <head>
    <title>E - Mami Donat Toko Ibu Rere Yuni</title>
    <meta charset="utf-8">
	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item"><a href="<?php echo site_url('pages/tanya'); ?>" class="nav-link">Tanya - Tanya</a></li>
               <li class="nav-item">
                    <?php if ( is_login() && is_customer()) : ?>
                     <a href="<?php echo site_url('customer'); ?>" class="nav-link">Akun Saya</a>
                       <?php else : ?>
                    <a href="<?php echo site_url('auth/login'); ?>" class="nav-link">akun</a></li>
                     <?php endif; ?>
